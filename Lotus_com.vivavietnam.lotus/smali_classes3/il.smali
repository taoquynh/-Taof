...
.method private a(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 93
    invoke-direct {p0, p1, p2}, Lil;->b(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 95
    invoke-direct {p0, p2}, Lil;->a(Landroid/net/Uri;)I
...
.method private a(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    .line 72
    iget-object v0, p0, Lil;->a:Landroid/content/Context;
    ...
    .line 73
    iget-object p1, p0, Lil;->a:Landroid/content/Context;
    ...
    .line 80
    iget-object v1, p0, Lil;->a:Landroid/content/Context;
...
.method public a(Landroid/net/Uri;IILcb;)Lef;
    ...
    .line 62
    invoke-direct {p0, p1, p2}, Lil;->a(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    .line 63
    invoke-direct {p0, p2, p1}, Lil;->a(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    .line 65
    iget-object p3, p0, Lil;->a:Landroid/content/Context;

    invoke-static {p3, p2, p1}, Lii;->a(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    .line 66
    invoke-static {p1}, Lik;->a(Landroid/graphics/drawable/Drawable;)Lef;
...
.method public bridge synthetic a(Ljava/lang/Object;IILcb;)Lef;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lil;->a(Landroid/net/Uri;IILcb;)Lef;
...
.method public bridge synthetic a(Ljava/lang/Object;Lcb;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lil;->a(Landroid/net/Uri;Lcb;)Z
