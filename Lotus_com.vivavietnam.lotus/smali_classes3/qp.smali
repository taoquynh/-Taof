...
# static fields
.field private static final a:Ljava/lang/String; = "qp"
...
.method public static declared-synchronized a()Lqy;
    .locals 7
    ...
    .line 84
    new-instance v4, Lqp$a;

    new-instance v5, Ljava/io/BufferedInputStream;

    invoke-direct {v5, v3}, Ljava/io/BufferedInputStream;-><init>(Ljava/io/InputStream;)V

    invoke-direct {v4, v5}, Lqp$a;-><init>(Ljava/io/InputStream;)V
    :try_end_1
    ...
    .line 86
    :try_start_2
    invoke-virtual {v4}, Lqp$a;->readObject()Ljava/lang/Object;
    ...
    .line 92
    :try_start_3
    invoke-static {v4}, Lvi;->a(Ljava/io/Closeable;)V
    :try_end_3
    ...
    :goto_1
    :try_start_6
    sget-object v5, Lqp;->a:Ljava/lang/String;
...
.method public static declared-synchronized a(Lqb;Lra;)V
    .locals 3
    ...
    .line 49
    invoke-virtual {v1, p0}, Lqy;->b(Lqb;)Z
    ...
    .line 51
    invoke-virtual {v1, p0}, Lqy;->a(Lqb;)Ljava/util/List;

    move-result-object p0

    .line 52
    invoke-virtual {p1}, Lra;->b()Ljava/util/List;
    ...
    invoke-virtual {v1, p0, p1}, Lqy;->a(Lqb;Ljava/util/List;)V

    .line 57
    :goto_0
    invoke-static {v1}, Lqp;->a(Lqy;)V
    :try_end_0
...
.method public static declared-synchronized a(Lqh;)V
    .locals 5
    ...
    .line 64
    invoke-virtual {p0}, Lqh;->a()Ljava/util/Set;
    ...
    .line 65
    invoke-virtual {p0, v3}, Lqh;->a(Lqb;)Lra;

    move-result-object v4

    .line 69
    invoke-virtual {v4}, Lra;->b()Ljava/util/List;

    move-result-object v4

    .line 67
    invoke-virtual {v1, v3, v4}, Lqy;->a(Lqb;Ljava/util/List;)V
