...
.field private static final d:Labb;
...
.method public static a(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    .line 55
    invoke-static {p0, v0}, Ladn;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 59
    invoke-static {p0, v0, v1, p1}, Labb;->a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V

    return-object v0
.end method

.method public static a(Landroid/content/Context;ILado;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
    ...
    .line 114
    :cond_2
    invoke-static {p0, p1}, Ladn;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 117
    :cond_3
    invoke-static {p0, p1}, Ladn;->e(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 120
    :cond_4
    invoke-static {p0, p1}, Ladn;->a(Landroid/content/Context;I)Ljava/lang/String;
...
.method public static a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    .line 129
    invoke-static {p1, p3}, Labg;->a(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Labg;

    move-result-object p1

    .line 130
    invoke-virtual {p1, p0, p2}, Labg;->show(Landroidx/fragment/app/FragmentManager;Ljava/lang/String;)V
...
.method private final a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    .line 137
    invoke-virtual {p0, p1}, Labb;->b(Landroid/content/Context;)V
    ...
    .line 143
    :cond_2
    invoke-static {p1, p2}, Ladn;->b(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object p3

    .line 144
    invoke-static {p1, p2}, Ladn;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    .line 153
    invoke-static {p1}, Lagb;->a(Landroid/content/Context;)Z
    ...
    .line 154
    invoke-static {}, Lagf;->f()Z

    move-result v0

    invoke-static {v0}, Lady;->a(Z)V
    ...
    .line 158
    invoke-static {p1}, Lagb;->b(Landroid/content/Context;)Z
    ...
    .line 159
    sget v0, Laav$b;->common_full_open_on_phone:I

    sget v3, Laav$c;->common_open_on_phone:I
    ...
    sget v4, Laav$c;->common_google_play_services_notification_ticker:I
    ...
    invoke-static {p4}, Lady;->a(Z)V

    .line 173
    invoke-direct {p0}, Labb;->c()Ljava/lang/String;
    ...
    .line 179
    invoke-static {p1}, Ladn;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 191
    sget-object p3, Labd;->sCanceledAvailabilityNotification:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public a(Landroid/content/Context;)I
    ...
    .line 93
    invoke-super {p0, p1}, Labc;->a(Landroid/content/Context;)I
...
.method public a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    .line 15
    invoke-virtual {p0, p1, p2, v0}, Labb;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    .line 17
    invoke-static {p1, v0, p3}, Lado;->a(Landroid/app/Activity;Landroid/content/Intent;I)Lado;

    move-result-object p3

    .line 18
    invoke-static {p1, p2, p3, p4}, Labb;->a(Landroid/content/Context;ILado;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public a(Landroid/content/Context;II)Landroid/app/PendingIntent;
    ...
    .line 97
    invoke-super {p0, p1, p2, p3}, Labc;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public a(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, p1, p2, v0}, Labb;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    .line 96
    invoke-super {p0, p1, p2, p3}, Labc;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public final a(Landroid/content/Context;Lacg;)Lcom/google/android/gms/common/api/internal/zabq;
    .locals 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-direct {v1, p2}, Lcom/google/android/gms/common/api/internal/zabq;-><init>(Lacg;)V
    ...
    .line 66
    invoke-virtual {p0, p1, v0}, Labb;->a(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public a(Landroid/content/Context;I)V
    ...
    .line 35
    invoke-virtual {p0, p1, p2, v1, v0}, Labc;->a(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;
    ...
    .line 36
    invoke-direct {p0, p1, p2, v1, v0}, Labb;->a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
...
.method public final a(Landroid/app/Activity;Labs;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 1
    .param p2    # Labs;
    ...
    .line 20
    invoke-virtual {p0, p1, p3, p4}, Labb;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    .line 22
    invoke-static {p2, p4, v0}, Lado;->a(Labs;Landroid/content/Intent;I)Lado;

    move-result-object p2

    .line 23
    invoke-static {p1, p3, p2, p5}, Labb;->a(Landroid/content/Context;ILado;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    .line 26
    invoke-static {p1, p2, p3, p5}, Labb;->a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public final a(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)Z
    ...
    .line 41
    invoke-virtual {p0, p1, p2}, Labb;->a(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)Landroid/app/PendingIntent;
    ...
    .line 46
    invoke-direct {p0, p1, p2, v1, p3}, Labb;->a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
...
.method public b(Landroid/content/Context;I)I
    ...
    .line 94
    invoke-super {p0, p1, p2}, Labc;->b(Landroid/content/Context;I)I
...
.method public final b(I)Ljava/lang/String;
    ...
    .line 102
    invoke-super {p0, p1}, Labc;->b(I)Ljava/lang/String;
...
.method public final b(Landroid/content/Context;)V
    ...
    .line 195
    new-instance v0, Labb$a;

    invoke-direct {v0, p0, p1}, Labb$a;-><init>(Labb;Landroid/content/Context;)V
...
.method public b(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Z
    ...
    .line 28
    invoke-virtual {p0, p1, p2, p3, p4}, Labb;->a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    .line 31
    invoke-static {p1, p2, p3, p4}, Labb;->a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
