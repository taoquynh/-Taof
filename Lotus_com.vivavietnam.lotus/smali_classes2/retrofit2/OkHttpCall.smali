...
.method private createRawCall()Lfll;
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lretrofit2/ServiceMethod;->toRequest([Ljava/lang/Object;)Lfmo;
    ...
    iget-object v1, v1, Lretrofit2/ServiceMethod;->callFactory:Lfll$a;
...
.method public cancel()V
    ...
    .line 226
    :try_start_0
    iget-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Lfll;
...
.method public enqueue(Lretrofit2/Callback;)V
    ...
    .line 85
    :try_start_1
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->createRawCall()Lfll;

    move-result-object v2

    iput-object v2, p0, Lretrofit2/OkHttpCall;->rawCall:Lfll;
    :try_end_1
...
.method public execute()Lretrofit2/Response;
    ...
    iput-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Lfll;
    :try_end_1
    ...
    invoke-virtual {p0, v0}, Lretrofit2/OkHttpCall;->parseResponse(Lfmt;)Lretrofit2/Response;
...
.method parseResponse(Lfmt;)Lretrofit2/Response;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v2, v3, v4}, Lretrofit2/OkHttpCall$NoContentResponseBody;-><init>(Lfmi;J)V

    invoke-virtual {p1, v1}, Lfmt$a;->a(Lfmu;)Lfmt$a;
    ...
    invoke-direct {v1, v0}, Lretrofit2/OkHttpCall$ExceptionCatchingRequestBody;-><init>(Lfmu;)V

    .line 211
    :try_start_0
    iget-object v0, p0, Lretrofit2/OkHttpCall;->serviceMethod:Lretrofit2/ServiceMethod;

    invoke-virtual {v0, v1}, Lretrofit2/ServiceMethod;->toResponse(Lfmu;)Ljava/lang/Object;

    move-result-object v0

    .line 212
    invoke-static {v0, p1}, Lretrofit2/Response;->success(Ljava/lang/Object;Lfmt;)Lretrofit2/Response;
    ...
    :goto_1
    :try_start_1
    invoke-static {v0}, Lretrofit2/Utils;->buffer(Lfmu;)Lfmu;

    move-result-object v1

    .line 199
    invoke-static {v1, p1}, Lretrofit2/Response;->error(Lfmu;Lfmt;)Lretrofit2/Response;
...
.method public declared-synchronized request()Lfmo;
    .locals 3
    ...
    .line 51
    invoke-interface {v0}, Lfll;->a()Lfmo;
