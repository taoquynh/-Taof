...
.field final callFactory:Lfll$a;
...
.method constructor <init>(Lretrofit2/ServiceMethod$Builder;)V
    ...
    invoke-virtual {v0}, Lretrofit2/Retrofit;->callFactory()Lfll$a;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/ServiceMethod;->callFactory:Lfll$a;
    ...
    invoke-virtual {v0}, Lretrofit2/Retrofit;->baseUrl()Lfmg;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/ServiceMethod;->baseUrl:Lfmg;
    ...
    .line 86
    iget-object v0, p1, Lretrofit2/ServiceMethod$Builder;->headers:Lfmf;

    iput-object v0, p0, Lretrofit2/ServiceMethod;->headers:Lfmf;

    .line 87
    iget-object v0, p1, Lretrofit2/ServiceMethod$Builder;->contentType:Lfmi;

    iput-object v0, p0, Lretrofit2/ServiceMethod;->contentType:Lfmi;
...
# virtual methods
.method varargs toRequest([Ljava/lang/Object;)Lfmo;
    .locals 10
    ...
    iget-object v2, p0, Lretrofit2/ServiceMethod;->baseUrl:Lfmg;

    iget-object v3, p0, Lretrofit2/ServiceMethod;->relativeUrl:Ljava/lang/String;

    iget-object v4, p0, Lretrofit2/ServiceMethod;->headers:Lfmf;

    iget-object v5, p0, Lretrofit2/ServiceMethod;->contentType:Lfmi;
    ...
    invoke-direct/range {v0 .. v8}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lfmg;Ljava/lang/String;Lfmf;Lfmi;ZZZ)V
    ...
    .line 112
    :cond_1
    invoke-virtual {v9}, Lretrofit2/RequestBuilder;->build()Lfmo;
...
.method toResponse(Lfmu;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
