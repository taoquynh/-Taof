...
.field final synthetic b:Legs;


# direct methods
.method public constructor <init>(Legs;Lcve;Landroid/view/View;)V
    .locals 0
...
.method public a(I)V
    ...
    .line 72
    iget-object v0, p0, Legs$a;->b:Legs;

    invoke-static {v0}, Legs;->a(Legs;)Ljava/util/List;
    ...
    invoke-static {v0}, Legs;->b(Legs;)Landroid/content/Context;
    ...
    iget-object v1, p0, Legs$a;->a:Lcve;

    iget-object v1, v1, Lcve;->a:Landroid/widget/ImageView;

    .line 80
    invoke-virtual {v0, v1}, Lbe;->a(Landroid/widget/ImageView;)Lld;

    .line 82
    iget-object v0, p0, Legs$a;->itemView:Landroid/view/View;

    new-instance v1, Legt;

    invoke-direct {v1, p0, p1}, Legt;-><init>(Legs$a;Lcom/vccorp/base/entity/request/comment/gif/GifData;)V
