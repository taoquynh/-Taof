...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lfay;-><init>(Leye;)V
...
.method private declared-synchronized a()V
    ...
    .line 70
    :try_start_0
    iput-boolean v0, p0, Lfay;->d:Z

    const/4 v0, 0x0

    .line 71
    iput-object v0, p0, Lfay;->c:Ljavax/net/ssl/SSLSocketFactory;
    :try_end_0
...
.method private declared-synchronized b()Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 122
    :try_start_0
    iget-object v0, p0, Lfay;->c:Ljavax/net/ssl/SSLSocketFactory;

    if-nez v0, :cond_0

    iget-boolean v0, p0, Lfay;->d:Z

    if-nez v0, :cond_0

    .line 123
    invoke-direct {p0}, Lfay;->c()Ljavax/net/ssl/SSLSocketFactory;
...
.method private declared-synchronized c()Ljavax/net/ssl/SSLSocketFactory;
    ...
    .line 132
    :try_start_1
    iget-object v0, p0, Lfay;->b:Lfbf;

    .line 133
    invoke-static {v0}, Lfbe;->a(Lfbf;)Ljavax/net/ssl/SSLSocketFactory;

    move-result-object v0

    .line 134
    iget-object v1, p0, Lfay;->a:Leye;
...
# virtual methods
.method public a(Lfba;Ljava/lang/String;)Lio/fabric/sdk/android/services/network/HttpRequest;
    .locals 1
    ...
    invoke-virtual {p0, p1, p2, v0}, Lfay;->a(Lfba;Ljava/lang/String;Ljava/util/Map;)Lio/fabric/sdk/android/services/network/HttpRequest;
...
.method public a(Lfba;Ljava/lang/String;Ljava/util/Map;)Lio/fabric/sdk/android/services/network/HttpRequest;
    .locals 1
    ...
    invoke-virtual {p1}, Lfba;->ordinal()I
    ...
    .line 105
    :goto_0
    invoke-direct {p0, p2}, Lfay;->a(Ljava/lang/String;)Z

    move-result p2

    if-eqz p2, :cond_0

    iget-object p2, p0, Lfay;->b:Lfbf;

    if-eqz p2, :cond_0

    .line 106
    invoke-direct {p0}, Lfay;->b()Ljavax/net/ssl/SSLSocketFactory;
...
.method public a(Lfbf;)V
    ...
    .line 64
    iput-object p1, p0, Lfay;->b:Lfbf;

    .line 65
    invoke-direct {p0}, Lfay;->a()V
