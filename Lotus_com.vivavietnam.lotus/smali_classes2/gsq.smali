...
# direct methods
.method constructor <init>(Lgso;Lvn/viva/tgnet/TLRPC$TL_updateNewChannelMessage;)V
    .locals 0

    .line 3129
    iput-object p1, p0, Lgsq;->b:Lgso;

    iput-object p2, p0, Lgsq;->a:Lvn/viva/tgnet/TLRPC$TL_updateNewChannelMessage;
...
.method public run()V
    ...
    iget-object v1, p0, Lgsq;->a:Lvn/viva/tgnet/TLRPC$TL_updateNewChannelMessage;

    iget v1, v1, Lvn/viva/tgnet/TLRPC$TL_updateNewChannelMessage;->pts:I

    iget-object v2, p0, Lgsq;->a:Lvn/viva/tgnet/TLRPC$TL_updateNewChannelMessage;

    iget v2, v2, Lvn/viva/tgnet/TLRPC$TL_updateNewChannelMessage;->pts_count:I

    iget-object v3, p0, Lgsq;->a:Lvn/viva/tgnet/TLRPC$TL_updateNewChannelMessage;
