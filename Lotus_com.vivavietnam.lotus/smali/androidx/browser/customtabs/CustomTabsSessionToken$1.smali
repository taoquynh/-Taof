...
.method public extraCallback(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iget-object v0, v0, Landroidx/browser/customtabs/CustomTabsSessionToken;->mCallbackBinder:Laf;

    invoke-interface {v0, p1, p2}, Laf;->extraCallback(Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_0
...
.method public onMessageChannelReady(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1}, Laf;->onMessageChannelReady(Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onNavigationEvent(ILandroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1, p2}, Laf;->onNavigationEvent(ILandroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onPostMessage(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1, p2}, Laf;->onPostMessage(Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onRelationshipValidationResult(ILandroid/net/Uri;ZLandroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1, p2, p3, p4}, Laf;->onRelationshipValidationResult(ILandroid/net/Uri;ZLandroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
