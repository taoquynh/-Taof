...
.method public varargs constructor <init>(Ljava/lang/String;Lcom/coremedia/iso/boxes/TrackBox;[Lcom/coremedia/iso/IsoFile;)V
    ...
    .line 57
    invoke-virtual {v11}, Lbhe;->getDefault_KID()Ljava/util/UUID;
    ...
    .line 69
    invoke-virtual {v15}, Lcom/googlecode/mp4parser/authoring/CencMp4TrackImplImpl$FindSaioSaizPair;->getSaio()Lbgs;

    move-result-object v16

    .line 70
    invoke-virtual {v15}, Lcom/googlecode/mp4parser/authoring/CencMp4TrackImplImpl$FindSaioSaizPair;->getSaiz()Lbgt;

    move-result-object v15

    .line 73
    invoke-virtual/range {v16 .. v16}, Lbgs;->b()[J
    ...
    .line 89
    :cond_5
    invoke-virtual {v15, v2}, Lbgt;->a(I)S
    ...
    .line 91
    invoke-virtual {v11}, Lbhe;->getDefaultIvSize()I
    ...
    invoke-direct {v0, v7, v6, v8, v9}, Lcom/googlecode/mp4parser/authoring/CencMp4TrackImplImpl;->parseCencAuxDataFormat(ILjava/nio/ByteBuffer;J)Lbhd;
    ...
    .line 104
    invoke-virtual {v2}, Lbhe;->getDefault_KID()Ljava/util/UUID;
    ...
    .line 114
    invoke-static {v4}, Lcom/googlecode/mp4parser/authoring/CencMp4TrackImplImpl$FindSaioSaizPair;->access$0(Lcom/googlecode/mp4parser/authoring/CencMp4TrackImplImpl$FindSaioSaizPair;)Lbgs;

    move-result-object v5

    .line 115
    invoke-static {v4}, Lcom/googlecode/mp4parser/authoring/CencMp4TrackImplImpl$FindSaioSaizPair;->access$1(Lcom/googlecode/mp4parser/authoring/CencMp4TrackImplImpl$FindSaioSaizPair;)Lbgt;
    ...
    .line 132
    invoke-virtual {v2}, Lbhe;->getDefaultIvSize()I

    move-result v3

    invoke-virtual {v4, v6}, Lbgt;->a(I)S

    move-result v5

    int-to-long v7, v5

    invoke-direct {v0, v3, v9, v7, v8}, Lcom/googlecode/mp4parser/authoring/CencMp4TrackImplImpl;->parseCencAuxDataFormat(ILjava/nio/ByteBuffer;J)Lbhd;
    ...
    .line 151
    invoke-virtual {v4, v10}, Lbgt;->a(I)S
    ...
    invoke-direct {v0, v13, v14, v10, v11}, Lcom/googlecode/mp4parser/authoring/CencMp4TrackImplImpl;->parseCencAuxDataFormat(ILjava/nio/ByteBuffer;J)Lbhd;
    ...
    .line 145
    invoke-virtual {v4, v14}, Lbgt;->a(I)S
...
.method private parseCencAuxDataFormat(ILjava/nio/ByteBuffer;J)Lbhd;
    .locals 4
    ...
    iput-object v1, v0, Lbhd;->a:[B

    .line 169
    iget-object v1, v0, Lbhd;->a:[B
    ...
    .line 172
    new-array p1, p1, [Lbhd$j;

    iput-object p1, v0, Lbhd;->b:[Lbhd$j;

    const/4 p1, 0x0

    .line 173
    :goto_0
    iget-object p3, v0, Lbhd;->b:[Lbhd$j;
    ...
    .line 174
    invoke-virtual {v0, p4, v1, v2}, Lbhd;->a(IJ)Lbhd$j;
