...
.method private createCrashlyticsKits(Landroid/content/Context;)[Leyb;
    .locals 6
    ...
    invoke-interface {v2, v3, v4, p1}, Leye;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {p1, v3, v4}, Leye;->c(Ljava/lang/String;Ljava/lang/String;)V

    const/4 p1, 0x2

    .line 104
    new-array p1, p1, [Leyb;
    ...
    invoke-interface {v3, v4, v5, p1}, Leye;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    .line 114
    :cond_1
    new-array p1, v0, [Leyb;
...
.method public onCreate()Z
    ...
    .line 33
    invoke-virtual {p0, v0, v1, v2}, Lcom/crashlytics/android/CrashlyticsInitProvider;->shouldInitializeFabric(Landroid/content/Context;Lezh;Lcom/crashlytics/android/CrashlyticsInitProvider$EnabledCheckStrategy;)Z
    ...
    invoke-direct {p0, v1}, Lcom/crashlytics/android/CrashlyticsInitProvider;->createCrashlyticsKits(Landroid/content/Context;)[Leyb;

    move-result-object v1

    invoke-static {v0, v1}, Lext;->a(Landroid/content/Context;[Leyb;)Lext;
    ...
    invoke-interface {v0, v1, v2}, Leye;->c(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method shouldInitializeFabric(Landroid/content/Context;Lezh;Lcom/crashlytics/android/CrashlyticsInitProvider$EnabledCheckStrategy;)Z
    .locals 1

    .line 131
    invoke-virtual {p2, p1}, Lezh;->b(Landroid/content/Context;)Z
    ...
    .line 135
    :cond_0
    invoke-virtual {p2, p1}, Lezh;->d(Landroid/content/Context;)Z
