...
.field private final preferenceStore:Lfbk;


# direct methods
.method public constructor <init>(Lfbk;Lcom/crashlytics/android/core/CrashlyticsCore;)V
    .locals 0
    ...
    .line 29
    iput-object p1, p0, Lcom/crashlytics/android/core/PreferenceManager;->preferenceStore:Lfbk;
...
.method public static create(Lfbk;Lcom/crashlytics/android/core/CrashlyticsCore;)Lcom/crashlytics/android/core/PreferenceManager;
    .locals 1

    .line 25
    new-instance v0, Lcom/crashlytics/android/core/PreferenceManager;

    invoke-direct {v0, p0, p1}, Lcom/crashlytics/android/core/PreferenceManager;-><init>(Lfbk;Lcom/crashlytics/android/core/CrashlyticsCore;)V
...
.method setShouldAlwaysSendReports(Z)V
    ...
    .line 34
    iget-object v0, p0, Lcom/crashlytics/android/core/PreferenceManager;->preferenceStore:Lfbk;

    iget-object v1, p0, Lcom/crashlytics/android/core/PreferenceManager;->preferenceStore:Lfbk;
...
.method shouldAlwaysSendReports()Z
    ...
    invoke-direct {v0, v2}, Lfbl;-><init>(Leyb;)V

    .line 41
    iget-object v2, p0, Lcom/crashlytics/android/core/PreferenceManager;->preferenceStore:Lfbk;

    .line 42
    invoke-interface {v2}, Lfbk;->a()Landroid/content/SharedPreferences;
    ...
    iget-object v4, p0, Lcom/crashlytics/android/core/PreferenceManager;->preferenceStore:Lfbk;

    invoke-interface {v4}, Lfbk;->b()Landroid/content/SharedPreferences$Editor;
    ...
    .line 47
    invoke-interface {v2, v0}, Lfbk;->a(Landroid/content/SharedPreferences$Editor;)Z
    ...
    invoke-interface {v2}, Lfbk;->b()Landroid/content/SharedPreferences$Editor;
    ...
    invoke-interface {v0, v2}, Lfbk;->a(Landroid/content/SharedPreferences$Editor;)Z
