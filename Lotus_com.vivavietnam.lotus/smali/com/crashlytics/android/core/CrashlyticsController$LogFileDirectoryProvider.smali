...
# instance fields
.field private final rootFileStore:Lfbi;
...
.method public constructor <init>(Lfbi;)V
    ...
    .line 1796
    iput-object p1, p0, Lcom/crashlytics/android/core/CrashlyticsController$LogFileDirectoryProvider;->rootFileStore:Lfbi;
...
.method public getLogFileDir()Ljava/io/File;
    ...
    iget-object v1, p0, Lcom/crashlytics/android/core/CrashlyticsController$LogFileDirectoryProvider;->rootFileStore:Lfbi;

    invoke-interface {v1}, Lfbi;->a()Ljava/io/File;
